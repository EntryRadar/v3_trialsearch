...
const SegmentedControl: React.FC<{
  ...
  <div className="relative">
    ...
    <Controller
      ...
      control={control}
      render={({ field }) => (
        <div className="inline-flex rounded-md shadow-sm bg-blue-50/50 p-1">
          {['Yes', 'No', 'N/A'].map((option) => (
            <button
              key={option}
              type="button"
              onClick={() => field.onChange(option === 'N/A' ? '' : option)}
              className={`
                px-4 py-1.5 text-sm font-medium
                ${option === 'Yes' ? 'rounded-l-md' : ''}
                ${option === 'N/A' ? 'rounded-r-md' : ''}
                ${field.value === (option === 'N/A' ? '' : option)
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="md:col-span-1 space-y-4">
                <SegmentedControl
                  name="treatmentNaive"
                  control={control}
                  label="Treatment-Naive Patient"
                  description="Indicate whether you have received any previous treatment for your condition."
                />
                ...
                <SegmentedControl
                  ...
                  description="Indicate if you have had any previous surgery related to your condition."
                />

                <SegmentedControl
                  name="brainMetastases"
                  control={control}
                  label="Brain Metastases Status"
                  description="Indicate if you have brain metastases."
                />
                ...
                <SegmentedControl
                  ...
                  description="Indicate if your cancer has metastasized."
                />

                <SegmentedControl
                  name="progressedPDL1"
                  control={control}
                  label="Progressed on PD-1/PD-L1 Treatment"
                  description="Indicate if you have progressed on PD-1/PD-L1 treatment."
                />
